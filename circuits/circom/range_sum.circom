...
/**
 * Range-sum disclosure — Phase 4 skeleton
 *
 ...
 * In practice we instantiate a small set: range_sum_4, range_sum_8, range_sum_16.
 *
 * Public signals:
...
// Instantiate the 8-note variant. Phase 4 wiring will produce companion
// variants for N=4, 16 as needed.
