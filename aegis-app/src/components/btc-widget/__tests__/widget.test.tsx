...
describe("SbBTCWidget (Dialog)", () => {
  ...
  it("renders default trigger button", () => {
    render(<SbBTCWidget />);
    const button = screen.getByRole("button", { name: /open aegis/i });
  ...
  it("opens dialog when trigger is clicked", async () => {
    render(<SbBTCWidget />);
    const trigger = screen.getByRole("button", { name: /open aegis/i });
  ...
  it("shows deposit tab by default", async () => {
    render(<SbBTCWidget />);
    fireEvent.click(screen.getByRole("button", { name: /open aegis/i }));
  ...
  it("renders footer with links", async () => {
    ...
    expect(screen.getByRole("link", { name: /aegis/i })).toBeDefined();
