...
pub struct TransferRow {
    ...
    pub operation_type: i64,
    /// UTXOpia instruction discriminator: 14=transact, 15=unshield, 5=request_redemption, 16=redeem
...
impl EventStore {
    ...
    fn run_migrations(&self) -> Result<(), String> {
        ...
        // Add instruction_disc column to nullifier_events (UTXOpia instruction discriminator)
        let _ = conn.execute_batch(
