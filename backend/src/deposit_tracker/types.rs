...
pub struct PrepareStealthDepositRequest {
    /// User's viewing public key (66 hex chars = 33 bytes compressed)
    pub viewing_pub: String,
    /// User's spending public key (66 hex chars = 33 bytes compressed)
    pub spending_pub: String,
    /// Commitment computed by the SDK: Poseidon(notePubKey, amount) as hex (64 chars)
    pub commitment: String,
    /// Ephemeral public key generated by the SDK (66 hex chars)
    pub ephemeral_pub: String,
}
