...
```typescript
import { generateJoinSplitProof } from '@utxopia/sdk';
...
The UTXOpia program verifies Groth16 proofs on-chain using Solana's native BN254 syscalls:
...
> Source: `contracts/programs/utxopia/src/utils/groth16.rs`
