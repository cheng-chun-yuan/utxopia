...
PROGRAM_ID=Ho6UTeF8yFnRdCK15tSZtcJozvkDABJZWYxkgGyWAfyq
...
7. **On-chain**: `complete_deposit` validates SPV proof, computes commitment on-chain (`Poseidon(npk, ZKBTC_TOKEN_ID, amount)`), emits stealth announcement event, adds commitment to Merkle tree
