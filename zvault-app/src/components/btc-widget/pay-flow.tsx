  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (isPublicRedeem) {
        ...
        const { buildPublicRedeemInstructionData } = await import("@zvault/sdk");
      ...
      let inputsData: {
        ...
        // For imported notes: phrase-derived ZVaultKeys
        importedKeys?: import("@zvault/sdk").ZVaultKeys;
      }[];
      ...
      if (hasImportedNotes) {
        ...
        const { scanUnifiedNotes: scanNotes } = await import("@zvault/sdk");
      ...
      for (const output of orderedOutputs) {
        ...
        if (output.mode === "btc") {
          ...
          // Note output: derive full ZVaultKeys from phrase, create proper stealth deposit
      ...
      const { createRedeemBoundParams } = await import("@zvault/sdk");
      ...
      if (isBtcRedeem && btcOutput) {
        ...
        const { buildRedeemInstructionData } = await import("@zvault/sdk");
