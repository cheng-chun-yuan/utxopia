...
/// BTC Light Client program ID — localnet (C8JoSKzondM7X1ESwrBSodGMrXWtEWNmawXyjh9zEWJZ)
/// Generated from target/deploy/btc_light_client-keypair.json
#[cfg(feature = "localnet")]
pub const BTC_LIGHT_CLIENT_PROGRAM_ID: [u8; 32] = [
    0xa5, 0x4f, 0xbf, 0xc4, 0x89, 0x7f, 0xa5, 0x53,
    0x1c, 0x76, 0xa4, 0x82, 0xba, 0xce, 0x0f, 0x72,
    0x9d, 0x18, 0x8b, 0xc4, 0x4e, 0x4d, 0xdb, 0xe9,
    0xf2, 0x1d, 0x69, 0x81, 0xa2, 0x08, 0x41, 0xa6,
];
