...
- [ ] **Phase 3d-full — merged JoinSplit+PoI**: bake the association-set check into the JoinSplit circuit itself so users get PoI automatically on every spend without a separate attest call. Much bigger surface (91 joinsplit_NxM variants, new instruction, new VK registry slot) — defer until 3d-lite usage warrants it.
